...
from text_analysis_function import clean_text, detect_lang, pourcentageResult
from text_analysis_function import english_SIA_textAnalysis, french_SIA_textAnalysis
